// https://github.com/blender/blender/blob/main/source/blender/gpu/shaders/material/gpu_shader_material_noise.glsl

// Requires CommonHash.js
...
float noise(vec2 p){ return 0.5 * snoise(p) + 0.5; }
...
float noise(vec4 p){ return 0.5 * snoise(p) + 0.5; }
`;